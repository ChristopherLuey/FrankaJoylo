"""Example: Teleop mode — Joylo leads, Franka follows."""
...
def main():
    ...
    system = JoyloSystem(franka, joylo, control_rate_hz=100.0, smoothing_alpha=0.95)

    print("Starting teleop mode (Joylo leads, Franka follows)...")
    system.start_teleop()
